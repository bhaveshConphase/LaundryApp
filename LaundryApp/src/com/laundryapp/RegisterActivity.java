...
LoaderCallbacks<Cursor> {
	...
	private void UIReferences()
	{
		...
		mPhoneView = (EditText)findViewById(R.id.editTextPhone);
		mCreditView = (EditText)findViewById(R.id.editTextCredit);
	...
	public void attemptRegistration() {
		...
		if (TextUtils.isEmpty(phone)) {
			...
			mPhoneView.setError(getString(R.string.error_invalid_mobile));
			focusView = mPhoneView;
			cancel = true;
		}
		...
		if (cancel) {
			...
			showProgress(true);
			mAuthTask = new UserRegistrationTask(email, password, phone);
	...
	public class UserRegistrationTask extends AsyncTask<Void, Void, Boolean> {
		...
		UserRegistrationTask(String email, String password, String phone) {
			mEmail = email;
			mPassword = password;
			mPhone = phone;
		}
